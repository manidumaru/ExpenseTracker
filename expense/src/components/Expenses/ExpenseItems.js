...
function ExpenseItems(props) {
  ...
  const titleChanger = () => {
    ...
    // when above code is executed, it re-renders the ExpenseItem component 
    // because this state variable is defineed inside that component.
  }
  ...
  return (
    <Card className="expense-item">      
      ...
      <div className = "title-change">
        <button onClick = {titleChanger} className ="title-change-button">Change Title</button>
      </div>
    </Card>
  );
}
